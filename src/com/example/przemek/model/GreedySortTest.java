...
public class GreedySortTest {
	...
	public void sortingZeroTest() {
		this.setItem(item1, "Cape", 2, 0, 1);
		this.setItem(item2, "Buckler", 2, 0, 3);
		this.setItem(item3, "Ring", 1, 0, 2);
		this.setItem(item4, "Rags", 2, 0, 2);
		this.setItem(item5, "Sword", 4, 0, 1);
		model.Sort(List, List.size());
		assertTrue (List.get(0).GetName() == "Cape");
		assertTrue (List.get(1).GetName() == "Buckler");
		assertTrue (List.get(2).GetName() == "Ring");
		assertTrue (List.get(3).GetName() == "Rags");
		assertTrue (List.get(4).GetName() == "Sword");
	}
